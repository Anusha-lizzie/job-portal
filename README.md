This project is a role-based job portal application built using the MERN stack (MongoDB, Express.js, React, and Node.js). It includes the following key features:
